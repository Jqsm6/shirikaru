...
func (ah *animeHandlers) Upload() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, gin.H{"error": "failed to upload anime"})
			return
		}
...
func (ah *animeHandlers) GetAll() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, gin.H{"error": "failed to get anime"})
			return
		}
...
func (ah *animeHandlers) GetByID() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, gin.H{"error": "failed convert string to int"})
			return
		}
...
func (ah *animeHandlers) SearchByTitle() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			...
			c.IndentedJSON(http.StatusInternalServerError, gin.H{"error": "no anime found for this query"})
			return
		}
...
func (ah *animeHandlers) Delete() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, gin.H{"error": "failed to delete anime"})
			return
		}
